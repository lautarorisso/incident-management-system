 ...
 * when the circuit is open. The forward preserves the original HTTP method,
 * so this controller is mapped with {@link RequestMapping} (all methods): a
 * short-circuited POST, PUT or DELETE receives the same 503 response instead
 * of a 405 Method Not Allowed from a method-scoped mapping.
 */
@RestController
