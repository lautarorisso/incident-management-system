...
class NotificationRoutingServiceTest {
    ...
    @Test
    void incidentPriorityChangedRoutesToAssignee() {
        UUID assigneeId = UUID.randomUUID();
    ...
    void resolveNotificationTypeReturnsCorrectType() {
        ...
        assertEquals(NotificationType.INCIDENT_PRIORITY_CHANGED,
                routingService.resolveNotificationType("INCIDENT_PRIORITY_CHANGED"));
    }
    ...
    void buildTitleReturnsDescriptiveTitle() {
        ...
        assertEquals("Incident priority changed",
                routingService.buildTitle(NotificationType.INCIDENT_PRIORITY_CHANGED));
    }
}
